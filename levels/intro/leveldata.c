...
const Gfx intro_seg7_dl_0700B3A0[] = {
    ...
    G_TX_NOMASK, G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, G_TX_NOMASK, G_TX_NOLOD), gsSPTexture(0xFFFF,
    0xFFFF, 0, G_TX_RENDERTILE, G_ON),

        /*
    gsDPTileSync(),
    gsDPSetTile(G_IM_FMT_RGBA, G_IM_SIZ_16b, 8, 0, G_TX_RENDERTILE, 0, G_TX_WRAP | G_TX_NOMIRROR, 5,
    G_TX_NOLOD, G_TX_WRAP | G_TX_NOMIRROR, 5, G_TX_NOLOD), gsDPSetTileSize(0, 0, 0, (32 - 1) <<
    G_TEXTURE_IMAGE_FRAC, (32 - 1) << G_TEXTURE_IMAGE_FRAC), gsSPDisplayList(intro_seg7_dl_07008EA0),
    //SM face + 64 side gsSPDisplayList(intro_seg7_dl_07009E38), //SM Side gsSPTexture(0xFFFF, 0xFFFF,
    0, G_TX_RENDERTILE, G_OFF), gsDPPipeSync(), gsDPSetCombineMode(G_CC_SHADE, G_CC_SHADE),
...
ALIGNED8 static const u8 hitlogo_0[] = {
#include "levels/intro/hitlogo_0_cst.rgba16.inc.c"
};
ALIGNED8 static const u8 hitlogo_1[] = {
#include "levels/intro/hitlogo_1_cst.rgba16.inc.c"
};
ALIGNED8 static const u8 hitlogo_2[] = {
#include "levels/intro/hitlogo_2_cst.rgba16.inc.c"
};
ALIGNED8 static const u8 hitlogo_3[] = {
#include "levels/intro/hitlogo_3_cst.rgba16.inc.c"
};
ALIGNED8 static const u8 hitlogo_4[] = {
#include "levels/intro/hitlogo_4_cst.rgba16.inc.c"
};
ALIGNED8 static const u8 hitlogo_5[] = {
#include "levels/intro/hitlogo_5_cst.rgba16.inc.c"
};
ALIGNED8 static const u8 hitlogo_6[] = {
#include "levels/intro/hitlogo_6_cst.rgba16.inc.c"
};
ALIGNED8 static const u8 hitlogo_7[] = {
#include "levels/intro/hitlogo_7_cst.rgba16.inc.c"
};
ALIGNED8 static const u8 hitlogo_8[] = {
#include "levels/intro/hitlogo_8_cst.rgba16.inc.c"
};
ALIGNED8 static const u8 hitlogo_9[] = {
#include "levels/intro/hitlogo_9_cst.rgba16.inc.c"
};
ALIGNED8 static const u8 hitlogo_10[] = {
#include "levels/intro/hitlogo_10_cst.rgba16.inc.c"
};
ALIGNED8 static const u8 hitlogo_11[] = {
#include "levels/intro/hitlogo_11_cst.rgba16.inc.c"
};


const Gfx intro_planet[] = {
    // SM+64 3d display
    /*
    gsDPPipeSync(),
...
const Gfx intro_seg7_dl_0700C6A0[] = {
    ...
    G_TX_CLAMP, G_TX_CLAMP, 4, 4, G_TX_NOLOD, G_TX_NOLOD), gsSPVertex(intro_seg7_vertex_0700B460, 4, 0),
    //tm gsSP2Triangles( 0,  1,  2, 0x0,  0,  2,  3, 0x0),
        */
